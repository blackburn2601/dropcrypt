...
{
    // BIP39 English wordlist (2048 words) - subset for demo
    // In production, load the full BIP39 wordlist
     ...
     */
    public function generate(int $wordCount = 24): string
    {
        $words = [];
        $wordlistSize = count($this->wordlist);
        
        for ($i = 0; $i < $wordCount; $i++) {
            $words[] = $this->wordlist[random_int(0, $wordlistSize - 1)];
        }
    ...
    public function validate(string $phrase): bool
    {
        ...
        foreach ($words as $word) {
            if (!in_array(strtolower($word), $this->wordlist, true)) {
                return false;
            }
        }
